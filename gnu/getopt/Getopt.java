...
/**
  * Returns non-flag arguments, with flags stripped off.  
  *
  * Should be called only after getopt() returns -1, i.e., all flags processed.
  *
  * Added by SJP, 10/5/2009
  */
public String[] getNonFlagArgs() {
    String[] result = new String[argv.length-optind];
    for (int i=0; i<result.length; i++)
	result[i] = argv[i+optind];
    return result;
}
