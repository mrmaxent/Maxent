 ...
 * Modified 8/11/2016 by Steven Phillips to officially implement DataInput (without supporting some methods).
 *
...
public class LittleEndianInputStream extends FilterInputStream implements DataInput {
   ...
   * Edited 8/11/2016 by Steven Phillips: removed unused argument (int b)
   *
  ...
  /**
   * readLine() is not currently supported
   */
  ...
  /**
   * readFully(byte[], int, int) is not currently supported
   */
  ...
  /**
   * readFully(byte[]) is not currently supported
   */
