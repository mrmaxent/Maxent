...
Fastering running time
New SWD (samples-with-data) input format
New Diva-GIS grid format
Optional automatic selection of feature types (linear / quadratic ...)
Parameters and information about the most recent run is written to "maxent.log"
